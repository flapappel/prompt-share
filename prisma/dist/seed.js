...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var adminPassword, admin, userPassword, user, categories, prompts;
                    ...
                    return [4 /*yield*/, Promise.all([
                            prisma.prompt.create({
                                data: {
                                    ...
                                    grade: client_1.Grade.GRADE_5_6,
                                    isApproved: true,
                            ...
                            prisma.prompt.create({
                                data: {
                                    ...
                                    grade: client_1.Grade.GRADE_3_4,
                                    isApproved: true,
                                    authorName: 'Test User',
                                    authorId: user.id,
                            ...
                            prisma.prompt.create({
                                data: {
                                    ...
                                    grade: client_1.Grade.GRADE_7_8,
                                    isApproved: false,
                                    authorName: 'Test User',
                                    authorId: user.id,
